...
var _halcwb$genapls$Util_Locals$local_ = function (n) {
	return A3(_cuducos$elm_format_number$FormatNumber_Locales$Locale, n, '.', ',');
};
var _halcwb$genapls$Util_Locals$locale0 = _halcwb$genapls$Util_Locals$local_(0);
var _halcwb$genapls$Util_Locals$locale1 = _halcwb$genapls$Util_Locals$local_(1);
var _halcwb$genapls$Util_Locals$locale2 = _halcwb$genapls$Util_Locals$local_(2);
var _halcwb$genapls$Util_Locals$local3 = _halcwb$genapls$Util_Locals$local_(3);

var _halcwb$genapls$Util_FixPrecision$countFirstInString = F2(
	function (c, s) {
		var _p0 = A3(
			_elm_lang$core$String$foldl,
			F2(
				function (c_, n0) {
					...
					var n = _p1._0;
					var is0 = _p1._1;
					return (is0 && _elm_lang$core$Native_Utils.eq(c_, c)) ? {ctor: '_Tuple2', _0: n + 1, _1: true} : {ctor: '_Tuple2', _0: n, _1: false};
				}),
			{ctor: '_Tuple2', _0: 0, _1: true},
			s);
		var n = _p0._0;
		return n;
	});
var _halcwb$genapls$Util_FixPrecision$getPower = F2(
	function (num, prec) {
		var _p2 = function () {
			var _p3 = A2(
				_elm_lang$core$String$split,
		...
		var n = _p2._0;
		var d = _p2._1;
		var l = _elm_lang$core$Native_Utils.eq(n, '0') ? 0 : _elm_lang$core$String$length(n);
		var p = (_elm_lang$core$Native_Utils.cmp(prec - l, 0) < 0) ? 0 : (prec - l);
		return (_elm_lang$core$Native_Utils.eq(d, '') || (_elm_lang$core$Native_Utils.cmp(num, 1) > 0)) ? p : (p + A2(
			_halcwb$genapls$Util_FixPrecision$countFirstInString,
			_elm_lang$core$Native_Utils.chr('0'),
			d));
	});
var _halcwb$genapls$Util_FixPrecision$fixPrecision = F2(
	function (prec, num) {
		return A2(
			_cuducos$elm_format_number$FormatNumber$format,
			_halcwb$genapls$Util_Locals$local_(
				A2(_halcwb$genapls$Util_FixPrecision$getPower, num, prec)),
			num);
	});

var _halcwb$genapls$Util_FloatUtils$printVolume = function (v) {
	return (_elm_lang$core$Native_Utils.cmp(v, 1) > -1) ? A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 2, v) : A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 1, v);
};
var _halcwb$genapls$Util_FloatUtils$roundBy = F2(
	function (s, n) {
		return function (f) {
			return f * s;
		}(
			_elm_lang$core$Basics$toFloat(
				_elm_lang$core$Basics$round(n / s)));
	});
var _halcwb$genapls$Util_FloatUtils$roundBy0_5 = _halcwb$genapls$Util_FloatUtils$roundBy(0.5);
var _halcwb$genapls$Util_FloatUtils$calcDoseVol = F5(
	function (kg, dosePerKg, conc, min, max) {
		var d = kg * dosePerKg;
		var d_ = ((_elm_lang$core$Native_Utils.cmp(max, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(d, max) > 0)) ? max : (((_elm_lang$core$Native_Utils.cmp(min, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(d, min) < 0)) ? min : d);
		var v = d_ / conc;
		var v_ = (_elm_lang$core$Native_Utils.cmp(v, 10) > -1) ? A2(_halcwb$genapls$Util_FloatUtils$roundBy, 1, v) : A2(_halcwb$genapls$Util_FloatUtils$roundBy, 0.1, v);
		return {ctor: '_Tuple2', _0: v_ * conc, _1: v_};
	});

var _halcwb$genapls$Util_ListUtils$isRagged = function (xs) {
	var _p0 = A2(_elm_lang$core$List$map, _elm_lang$core$List$length, xs);
	if (_p0.ctor === '[]') {
		return false;
	} else {
		return !A2(
...
var _halcwb$genapls$Util_ListUtils$transpose = function (xs) {
	if (_halcwb$genapls$Util_ListUtils$isRagged(xs)) {
		return _elm_lang$core$Result$Err('Cannot transpose a ragged list of lists');
	} else {
		if (_elm_lang$core$List$isEmpty(xs)) {
			return _elm_lang$core$Result$Ok(xs);
		} else {
			var trans_ = F4(
				function (xs, rest, row, acc) {
					trans_:
					while (true) {
						var _p1 = xs;
						if (_p1.ctor === '[]') {
							...
							var _p2 = _p1._0;
							if (_p2.ctor === '[]') {
								return _elm_lang$core$List$isEmpty(acc) ? {
									ctor: '::',
									_0: {ctor: '[]'},
									_1: {ctor: '[]'}
								} : acc;
...
var _halcwb$genapls$Util_ListUtils$mapi = F2(
	function (f, xs) {
		var mapi_ = F3(
			function (i, xs_, map_) {
				var _p3 = xs_;
...
var _halcwb$genapls$Util_ListUtils$removeDuplicates = function (xs) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (x, xs) {
...
var _halcwb$genapls$Util_ListUtils$findNearestMax = F2(
	function (n, ns) {
		var _p4 = ns;
		if (_p4.ctor === '[]') {
			return n;
			...
			return A3(
				...
				F2(
					function (a, x) {
						return (_elm_lang$core$Native_Utils.cmp(a - x, n - x) < 0) ? x : a;
					}),
				n,
				_elm_lang$core$List$reverse(
					_elm_lang$core$List$sort(ns)));
		}
	});

var _halcwb$genapls$Data_Medication$medicationDefs = {
	ctor: '::',
	_0: {ctor: '_Tuple8', _0: 'reanimatie', _1: 'glucose 10%', _2: 0.2, _3: 0, _4: 25, _5: 0.1, _6: 'gram', _7: ''},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple8', _0: 'reanimatie', _1: 'NaBic 8,4', _2: 0.5, _3: 0, _4: 50, _5: 1, _6: 'mmol', _7: ''},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'propofol 1%', _2: 2, _3: 0, _4: 0, _5: 10, _6: 'mg', _7: ''},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'propofol 2%', _2: 2, _3: 0, _4: 0, _5: 20, _6: 'mg', _7: ''},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'midazolam', _2: 0.2, _3: 0, _4: 10, _5: 5, _6: 'mg', _7: ''},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'esketamine', _2: 0.5, _3: 0, _4: 5, _5: 5, _6: 'mg', _7: ''},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'etomidaat', _2: 0.5, _3: 0, _4: 20, _5: 2, _6: 'mg', _7: ''},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'fentanyl', _2: 1, _3: 0, _4: 50, _5: 50, _6: 'mcg', _7: ''},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'morfine', _2: 0.1, _3: 0, _4: 10, _5: 1, _6: 'mg', _7: ''},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'rocuronium', _2: 1, _3: 0, _4: 10, _5: 10, _6: 'mg', _7: ''},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple8', _0: 'intubatie', _1: 'atropine', _2: 2.0e-2, _3: 0.1, _4: 0.5, _5: 0.5, _6: 'mg', _7: ''},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple8', _0: 'antidota', _1: 'flumazine', _2: 2.0e-2, _3: 0, _4: 0.3, _5: 0.1, _6: 'mg', _7: ''},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple8', _0: 'antidota', _1: 'naloxon', _2: 1.0e-2, _3: 0, _4: 0.5, _5: 2.0e-2, _6: 'mg', _7: ''},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple8', _0: 'elektrolyten', _1: 'kaliumchloride 7,4%', _2: 0.5, _3: 0, _4: 40, _5: 1.0, _6: 'mmol', _7: ''},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple8', _0: 'elektrolyten', _1: 'calciumgluconaat', _2: 0.13, _3: 0, _4: 4.5, _5: 0.225, _6: 'mmol', _7: ''},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple8', _0: 'elektrolyten', _1: 'magnesiumchloride 10%', _2: 8.0e-2, _3: 0, _4: 0, _5: 0.5, _6: 'mmol', _7: ''},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple8', _0: 'antiarrythmica', _1: 'adenosine 1e gift', _2: 100, _3: 0, _4: 12000, _5: 3000, _6: 'microg', _7: ''},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple8', _0: 'antiarrythmica', _1: 'adenosine 2e gift', _2: 200, _3: 0, _4: 12000, _5: 3000, _6: 'microg', _7: ''},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple8', _0: 'antiarrythmica', _1: 'adenosine 3e gift', _2: 300, _3: 0, _4: 12000, _5: 3000, _6: 'microg', _7: ''},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple8', _0: 'antiarrythmica', _1: 'amiodarone', _2: 5, _3: 0, _4: 300, _5: 50, _6: 'mg', _7: ''},
																				_1: {
																					ctor: '::',
																					_0: {ctor: '_Tuple8', _0: 'anticonvulsiva', _1: 'diazepam', _2: 0.5, _3: 0, _4: 10, _5: 2, _6: 'mg', _7: ''},
																					_1: {
																						ctor: '::',
																						_0: {ctor: '_Tuple8', _0: 'anticonvulsiva', _1: 'fenytoine', _2: 20, _3: 0, _4: 1500, _5: 50, _6: 'mg', _7: ''},
																						_1: {
																							ctor: '::',
																							_0: {ctor: '_Tuple8', _0: 'anticonvulsiva', _1: 'midazolam', _2: 0.1, _3: 0, _4: 10, _5: 5, _6: 'mg', _7: ''},
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple8', _0: 'astma', _1: 'prednisolon', _2: 2, _3: 0, _4: 25, _5: 12.5, _6: 'mg', _7: ''},
																								_1: {
																									ctor: '::',
																									_0: {ctor: '_Tuple8', _0: 'astma', _1: 'magnesiumsulfaat 16%', _2: 40, _3: 0, _4: 2000, _5: 160, _6: 'mg', _7: ''},
																									_1: {
																										ctor: '::',
																										_0: {ctor: '_Tuple8', _0: 'astma', _1: 'magnesiumsulfaat 50%', _2: 40, _3: 0, _4: 2000, _5: 500, _6: 'mg', _7: ''},
																										_1: {
																											ctor: '::',
																											_0: {ctor: '_Tuple8', _0: 'astma', _1: 'salbutamol oplaad', _2: 15, _3: 0, _4: 0, _5: 500, _6: 'microg', _7: ''},
																											_1: {
																												ctor: '::',
																												_0: {ctor: '_Tuple8', _0: 'hersenoedeem', _1: 'mannitol 15%', _2: 0.5, _3: 0, _4: 50, _5: 0.15, _6: 'gram', _7: ''},
																												_1: {
																													ctor: '::',
																													_0: {ctor: '_Tuple8', _0: 'lokaal anesthesie', _1: 'licocaine 1%', _2: 5, _3: 0, _4: 200, _5: 10, _6: 'mg', _7: ''},
																													_1: {
																														ctor: '::',
																														_0: {ctor: '_Tuple8', _0: 'lokaal anesthesie', _1: 'licocaine 2%', _2: 5, _3: 0, _4: 200, _5: 20, _6: 'mg', _7: ''},
																														_1: {ctor: '[]'}
																													}
																												}
																											}
...
var _halcwb$genapls$Data_Medication$calculate = F2(
	function (kg, med) {
		var _p0 = A5(_halcwb$genapls$Util_FloatUtils$calcDoseVol, kg, med.dosePerKg, med.conc, med.min, med.max);
		var d = _p0._0;
		var v = _p0._1;
		return _elm_lang$core$Native_Utils.update(
			med,
			{
				dose: d,
				volume: A2(_halcwb$genapls$Util_FloatUtils$roundBy, 0.1, v)
			});
	});
var _halcwb$genapls$Data_Medication$print = function (med) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		med.category,
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale2, med.dose),
					A2(_elm_lang$core$Basics_ops['++'], ' ', med.unit)))));
};
var _halcwb$genapls$Data_Medication$printAdvice = function (med) {
	var minmax = function () {
		var _p1 = {
			ctor: '_Tuple2',
			_0: !_elm_lang$core$Native_Utils.eq(med.min, 0),
			_1: !_elm_lang$core$Native_Utils.eq(med.max, 0)
		};
		if (_p1._0 === true) {
			if (_p1._1 === true) {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(med.min),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' - ',
						_elm_lang$core$Basics$toString(med.max)));
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'min ',
	...
	var advice = _elm_lang$core$Basics$toString(med.dosePerKg);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		advice,
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						(!_elm_lang$core$Native_Utils.eq(minmax, '')) ? A2(
							_elm_lang$core$Basics_ops['++'],
							' (',
							A2(
								_elm_lang$core$Basics_ops['++'],
								...
								A2(
									...
									' ',
									A2(_elm_lang$core$Basics_ops['++'], med.unit, ')')))) : '',
						(!_elm_lang$core$Native_Utils.eq(med.remark, '')) ? A2(_elm_lang$core$Basics_ops['++'], ' ', med.remark) : '')))));
};
var _halcwb$genapls$Data_Medication$printDose = function (med) {
	return _elm_lang$core$Native_Utils.eq(med.dose, 0) ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 2, med.dose),
		A2(_elm_lang$core$Basics_ops['++'], ' ', med.unit));
};
var _halcwb$genapls$Data_Medication$printVolume = function (med) {
	return _elm_lang$core$Native_Utils.eq(med.volume, 0) ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		_halcwb$genapls$Util_FloatUtils$printVolume(med.volume),
		A2(_elm_lang$core$Basics_ops['++'], ' ', 'ml'));
};
var _halcwb$genapls$Data_Medication$printDoseVolume = function (med) {
	var v = _halcwb$genapls$Data_Medication$printVolume(med);
	var d = _halcwb$genapls$Data_Medication$printDose(med);
	return _elm_lang$core$Native_Utils.eq(d, '') ? {ctor: '_Tuple2', _0: '', _1: ''} : {
		ctor: '_Tuple2',
		_0: d,
		_1: _elm_lang$core$Native_Utils.eq(v, '') ? '' : A2(
			_elm_lang$core$Basics_ops['++'],
			_halcwb$genapls$Data_Medication$printVolume(med),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' van ',
				A2(
					...
					A3(
						...
						'.',
						',',
						_elm_lang$core$Basics$toString(med.conc)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						A2(_elm_lang$core$Basics_ops['++'], med.unit, '/ml')))))
	};
};
var _halcwb$genapls$Data_Medication$create = function (_p2) {
	var _p3 = _p2;
	return {category: _p3._0, name: _p3._1, dose: 0, dosePerKg: _p3._2, min: _p3._3, max: _p3._4, conc: _p3._5, volume: 0, unit: _p3._6, remark: _p3._7};
};
var _halcwb$genapls$Data_Medication$medicationList = A2(_elm_lang$core$List$map, _halcwb$genapls$Data_Medication$create, _halcwb$genapls$Data_Medication$medicationDefs);
var _halcwb$genapls$Data_Medication$medication = {category: '', name: '', dose: 0, dosePerKg: 0, min: 0, max: 0, conc: 0, volume: 0, unit: '', remark: ''};
var _halcwb$genapls$Data_Medication$Bolus = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {category: a, name: b, dose: c, dosePerKg: d, min: e, max: f, conc: g, volume: h, unit: i, remark: j};
									};
								};
							};
						};
...
var _halcwb$genapls$Util_Utils$toKeyValuePair = function (segment) {
...
var _halcwb$genapls$Util_Utils$parseParams = function (queryString) {
	return _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$filterMap,
			_halcwb$genapls$Util_Utils$toKeyValuePair,
			A2(
				_elm_lang$core$String$split,
				'&',
...
var _halcwb$genapls$Data_Intervention$printCardioversion = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.cardioversion, 0) ? {ctor: '_Tuple2', _0: '', _1: ''} : {
		ctor: '_Tuple2',
		_0: A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale0, model.cardioversion),
			' Joule'),
		_1: ''
	};
};
var _halcwb$genapls$Data_Intervention$printDefibrillation = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.defibrillation, 0) ? {ctor: '_Tuple2', _0: '', _1: ''} : {
		ctor: '_Tuple2',
		_0: A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale0, model.defibrillation),
			' Joule'),
		_1: ''
	};
};
var _halcwb$genapls$Data_Intervention$printFluidBolus = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.fluidBolus, 0) ? {ctor: '_Tuple2', _0: '', _1: ''} : {
		ctor: '_Tuple2',
		_0: A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale0, model.fluidBolus),
			' ml NaCl 0,9%'),
		_1: ''
	};
};
var _halcwb$genapls$Data_Intervention$printEpinephrine = F3(
	function (w, e, r) {
		if (_elm_lang$core$Native_Utils.eq(
			...
			var s1 = _p0._1;
			var s2 = _p0._2;
			var dosePerKg = A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 2, d / w);
			return {
				ctor: '_Tuple2',
				_0: A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 2, d),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' mg',
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'(',
									A2(_elm_lang$core$Basics_ops['++'], dosePerKg, ' mg/kg)')))))),
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					A2(
						_elm_lang$core$Basics_ops['++'],
						_halcwb$genapls$Util_FloatUtils$printVolume(s1),
						' ml van 0,1 mg/ml (1:10.000) of '),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_halcwb$genapls$Util_FloatUtils$printVolume(s2),
						' ml van 1 mg/ml (1:1000)'))
			};
		}
	});
var _halcwb$genapls$Data_Intervention$printEpinephrineIV = function (model) {
	return A3(_halcwb$genapls$Data_Intervention$printEpinephrine, model.weight, model.epinephrineIV, '');
};
var _halcwb$genapls$Data_Intervention$printEpinephrineTR = function (model) {
	return A3(_halcwb$genapls$Data_Intervention$printEpinephrine, model.weight, model.epinephrineTR, '');
};
var _halcwb$genapls$Data_Intervention$printTubeLength = function (n) {
	return _elm_lang$core$Native_Utils.eq(n, 0) ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale1, n),
		' cm');
};
var _halcwb$genapls$Data_Intervention$printTubeLengthOral = function (model) {
	return _halcwb$genapls$Data_Intervention$printTubeLength(model.tubeLengthOral);
};
var _halcwb$genapls$Data_Intervention$printTubeLengthNasal = function (model) {
	return _halcwb$genapls$Data_Intervention$printTubeLength(model.tubeLengthNasal);
};
var _halcwb$genapls$Data_Intervention$printTubeSize = function (model) {
	if (_elm_lang$core$Native_Utils.eq(
		model.tubeSize,
		{ctor: '_Tuple3', _0: 0, _1: 0, _2: 0})) {
		return '';
	} else {
		var _p1 = model.tubeSize;
		var r = _p1._0;
		var c = _p1._1;
		var l = _p1._2;
		var print = function (n) {
			return A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale1, n);
		};
		return A2(
			_elm_lang$core$Basics_ops['++'],
			print(r),
...
var _halcwb$genapls$Data_Intervention$printWeight = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.weight, 0) ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale1, model.weight),
		' kg');
};
var _halcwb$genapls$Data_Intervention$isCalculated = function (model) {
	var _p2 = model.calculated;
	if (_p2.ctor === 'IsCalc') {
		return true;
	} else {
		return false;
...
var _halcwb$genapls$Data_Intervention$calcMeds = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			medications: A2(
				_elm_lang$core$List$map,
				_halcwb$genapls$Data_Medication$calculate(model.weight),
				model.medications)
		});
};
var _halcwb$genapls$Data_Intervention$calcEpinephrine = function (model) {
	var tr = A5(_halcwb$genapls$Util_FloatUtils$calcDoseVol, model.weight, 0.1, 0.1, 0.1, 5);
	var iv = A5(_halcwb$genapls$Util_FloatUtils$calcDoseVol, model.weight, 1.0e-2, 0.1, 1.0e-2, 0.5);
	return A2(
		...
		_elm_lang$core$Native_Utils.update(
			model,
			{
				epinephrineIV: {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Tuple$first(iv),
					_1: _elm_lang$core$Tuple$second(iv),
					_2: _elm_lang$core$Tuple$second(iv) / 10
				},
				epinephrineTR: {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Tuple$first(tr),
					_1: _elm_lang$core$Tuple$second(tr),
					_2: _elm_lang$core$Tuple$second(tr) / 10
				}
			}));
};
var _halcwb$genapls$Data_Intervention$calcTubLength = F2(
	function (n, model) {
		var l = A2(_halcwb$genapls$Util_FloatUtils$roundBy, 0.5, (model.age / 2) + n);
		return _elm_lang$core$Native_Utils.eq(n, 12) ? _elm_lang$core$Native_Utils.update(
			model,
			{tubeLengthOral: l}) : _elm_lang$core$Native_Utils.update(
			model,
			{tubeLengthNasal: l});
	});
var _halcwb$genapls$Data_Intervention$calcTubeLengthOral = _halcwb$genapls$Data_Intervention$calcTubLength(12);
var _halcwb$genapls$Data_Intervention$calcTubeLengthNasal = function (model) {
	return A2(_halcwb$genapls$Data_Intervention$calcTubLength, 15, model);
};
var _halcwb$genapls$Data_Intervention$calcMinMax = F4(
	function (min, max, f, x) {
		var y = f(x);
		return (_elm_lang$core$Native_Utils.cmp(y, max) > 0) ? max : ((_elm_lang$core$Native_Utils.cmp(y, min) < 0) ? min : y);
	});
var _halcwb$genapls$Data_Intervention$calcMax = _halcwb$genapls$Data_Intervention$calcMinMax(0);
var _halcwb$genapls$Data_Intervention$calcFluidBolus = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			fluidBolus: A3(
				_halcwb$genapls$Data_Intervention$calcMax,
				1000,
				function (n) {
					return A2(_halcwb$genapls$Util_FloatUtils$roundBy, 10, n * 20);
				},
				model.weight)
		});
};
var _halcwb$genapls$Data_Intervention$joules = {
	ctor: '::',
	_0: 1,
	_1: {
		ctor: '::',
...
var _halcwb$genapls$Data_Intervention$max_epi = 1;
var _halcwb$genapls$Data_Intervention$max_defib = 150;
var _halcwb$genapls$Data_Intervention$calcDefib = function (model) {
	var d = A2(_halcwb$genapls$Util_ListUtils$findNearestMax, model.weight * 4, _halcwb$genapls$Data_Intervention$joules);
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			defibrillation: (_elm_lang$core$Native_Utils.cmp(d, _halcwb$genapls$Data_Intervention$max_defib) > 0) ? _halcwb$genapls$Data_Intervention$max_defib : d
		});
};
var _halcwb$genapls$Data_Intervention$calcCardiov = function (model) {
	var d = A2(_halcwb$genapls$Util_ListUtils$findNearestMax, model.weight * 2, _halcwb$genapls$Data_Intervention$joules);
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			cardioversion: (_elm_lang$core$Native_Utils.cmp(d, _halcwb$genapls$Data_Intervention$max_defib) > 0) ? _halcwb$genapls$Data_Intervention$max_defib : d
		});
};
var _halcwb$genapls$Data_Intervention$max_weight = 150;
var _halcwb$genapls$Data_Intervention$min_weight = 3;
var _halcwb$genapls$Data_Intervention$setWeight = F2(
	function (txt, model) {
		var model_ = function () {
			var _p3 = _elm_lang$core$String$toFloat(txt);
			if (_p3.ctor === 'Ok') {
				var _p4 = _p3._0;
				return ((_elm_lang$core$Native_Utils.cmp(_p4, _halcwb$genapls$Data_Intervention$min_weight) > -1) && (_elm_lang$core$Native_Utils.cmp(_p4, _halcwb$genapls$Data_Intervention$max_weight) < 1)) ? _elm_lang$core$Native_Utils.update(
					model,
					{weight: _p4, weightText: txt, calcWeight: false}) : _elm_lang$core$Native_Utils.update(
					model,
					{weight: 0, weightText: txt, calcWeight: false});
			} else {
				return (_elm_lang$core$Native_Utils.eq(model.weight, 0) || _elm_lang$core$Native_Utils.eq(txt, '')) ? _elm_lang$core$Native_Utils.update(
					model,
					{weight: 0, weightText: '', calcWeight: false}) : model;
			}
		}();
		return model_;
	});
var _halcwb$genapls$Data_Intervention$half_age = 0.5;
var _halcwb$genapls$Data_Intervention$zero_age = 0;
var _halcwb$genapls$Data_Intervention$setAge = F3(
	function (a, age, model) {
		var _p5 = _elm_lang$core$String$toFloat(age);
		if (_p5.ctor === 'Ok') {
			var _p7 = _p5._0;
			if (_elm_lang$core$Native_Utils.cmp(_p7, _halcwb$genapls$Data_Intervention$zero_age) > -1) {
				var _p6 = a;
				if (_p6.ctor === 'Year') {
					return _elm_lang$core$Native_Utils.update(
						model,
						{age: _p7 + (model.month / 12), year: _p7, calcWeight: true});
				} else {
					return _elm_lang$core$Native_Utils.update(
						model,
						{age: model.year + (_p7 / 12), month: _p7, calcWeight: true});
				}
			} else {
				return model;
			}
...
var _halcwb$genapls$Data_Intervention$calcTubeSize = function (model) {
	var maxSize = 7.5;
	var calc = function (a) {
		var c = A3(
			_halcwb$genapls$Data_Intervention$calcMax,
			maxSize,
			function (n) {
				return A2(_halcwb$genapls$Util_FloatUtils$roundBy, 0.5, (n / 4) + 4);
			},
			a);
		var l = c - 0.5;
		var r = c + 0.5;
		return {ctor: '_Tuple3', _0: l, _1: c, _2: r};
	};
	return _elm_lang$core$Native_Utils.eq(model.age, _halcwb$genapls$Data_Intervention$zero_age) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			tubeSize: {ctor: '_Tuple3', _0: 3.0, _1: 3.5, _2: 4.0}
		}) : _elm_lang$core$Native_Utils.update(
		model,
		{
			tubeSize: calc(model.age)
		});
};
var _halcwb$genapls$Data_Intervention$no_age = -0.5;
var _halcwb$genapls$Data_Intervention$calcAge = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.age, _halcwb$genapls$Data_Intervention$no_age) ? model : _elm_lang$core$Native_Utils.update(
		model,
		{
			ageText: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale1, model.age),
				' jaar')
		});
};
var _halcwb$genapls$Data_Intervention$calcWeight = function (model) {
	if (model.calcWeight) {
		var age_6mo_weight = 6;
		var age_zero_weight = 3.5;
		if (_elm_lang$core$Native_Utils.eq(model.age, _halcwb$genapls$Data_Intervention$no_age)) {
			return model;
		} else {
			if (_elm_lang$core$Native_Utils.eq(model.age, _halcwb$genapls$Data_Intervention$zero_age)) {
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						weight: age_zero_weight,
						weightText: _elm_lang$core$Basics$toString(age_zero_weight)
					});
			} else {
				if ((_elm_lang$core$Native_Utils.cmp(model.age, _halcwb$genapls$Data_Intervention$zero_age) > 0) && (_elm_lang$core$Native_Utils.cmp(model.age, _halcwb$genapls$Data_Intervention$half_age) < 1)) {
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							weight: age_6mo_weight,
							weightText: _elm_lang$core$Basics$toString(age_6mo_weight)
						});
				} else {
					var w = (model.age * 2.5) + 8;
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							weight: w,
							weightText: _elm_lang$core$Basics$toString(w)
						});
				}
			}
		}
...
var _halcwb$genapls$Data_Intervention$printAge = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.age, _halcwb$genapls$Data_Intervention$no_age) ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_cuducos$elm_format_number$FormatNumber$format, _halcwb$genapls$Util_Locals$locale1, model.age),
		' jaar');
};
var _halcwb$genapls$Data_Intervention$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {age: a, year: b, month: c, ageText: d, weight: e, weightText: f, calcWeight: g, tubeSize: h, tubeLengthOral: i, tubeLengthNasal: j, epinephrineIV: k, epinephrineTR: l, fluidBolus: m, defibrillation: n, cardioversion: o, medications: p, calculated: q};
																};
															};
														};
													};
...
var _halcwb$genapls$Data_Intervention$Intervention = F6(
	function (a, b, c, d, e, f) {
		return {indication: a, intervention: b, value: c, preparation: d, solution: e, advice: f};
	});
var _halcwb$genapls$Data_Intervention$Month = {ctor: 'Month'};
var _halcwb$genapls$Data_Intervention$Year = {ctor: 'Year'};
var _halcwb$genapls$Data_Intervention$NotCalc = {ctor: 'NotCalc'};
var _halcwb$genapls$Data_Intervention$model = {
	age: _halcwb$genapls$Data_Intervention$no_age,
	year: 0,
	month: 0,
	ageText: '',
	weight: 0,
	weightText: '',
	calcWeight: true,
	tubeSize: {ctor: '_Tuple3', _0: 0, _1: 0, _2: 0},
	tubeLengthOral: 0,
	tubeLengthNasal: 0,
	epinephrineIV: {ctor: '_Tuple3', _0: 0, _1: 0, _2: 0},
	epinephrineTR: {ctor: '_Tuple3', _0: 0, _1: 0, _2: 0},
	fluidBolus: 0,
	defibrillation: 0,
	cardioversion: 0,
	medications: _halcwb$genapls$Data_Medication$medicationList,
	calculated: _halcwb$genapls$Data_Intervention$NotCalc
};
var _halcwb$genapls$Data_Intervention$IsCalc = {ctor: 'IsCalc'};
var _halcwb$genapls$Data_Intervention$setCalculated = F2(
	function (b, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				calculated: b ? _halcwb$genapls$Data_Intervention$IsCalc : _halcwb$genapls$Data_Intervention$NotCalc
			});
	});
var _halcwb$genapls$Data_Intervention$calculate = function (mdl) {
	return _elm_lang$core$Native_Utils.eq(mdl.age, _halcwb$genapls$Data_Intervention$no_age) ? A2(_halcwb$genapls$Data_Intervention$setCalculated, false, _halcwb$genapls$Data_Intervention$model) : ((_elm_lang$core$Native_Utils.eq(mdl.weight, 0) && (!mdl.calcWeight)) ? mdl : A2(
		_halcwb$genapls$Data_Intervention$setCalculated,
		true,
		_halcwb$genapls$Data_Intervention$calcMeds(
			_halcwb$genapls$Data_Intervention$calcCardiov(
				_halcwb$genapls$Data_Intervention$calcDefib(
					_halcwb$genapls$Data_Intervention$calcFluidBolus(
						_halcwb$genapls$Data_Intervention$calcEpinephrine(
							_halcwb$genapls$Data_Intervention$calcTubeLengthOral(
								_halcwb$genapls$Data_Intervention$calcTubeLengthNasal(
									_halcwb$genapls$Data_Intervention$calcAge(
										_halcwb$genapls$Data_Intervention$calcTubeSize(
											_halcwb$genapls$Data_Intervention$calcWeight(mdl))))))))))));
};
var _halcwb$genapls$Data_Intervention$init = function (search) {
	var wght = function () {
		var _p8 = A2(
			_elm_lang$core$Dict$get,
			'weight',
			_halcwb$genapls$Util_Utils$parseParams(search));
		if (_p8.ctor === 'Just') {
			return _p8._0;
		} else {
			return '';
	...
	var initModel = _elm_lang$core$Native_Utils.eq(wght, '') ? A3(
		_halcwb$genapls$Data_Intervention$setAge,
		_halcwb$genapls$Data_Intervention$Month,
		months,
		A3(_halcwb$genapls$Data_Intervention$setAge, _halcwb$genapls$Data_Intervention$Year, years, _halcwb$genapls$Data_Intervention$model)) : A2(
		_halcwb$genapls$Data_Intervention$setWeight,
		wght,
		A3(
			_halcwb$genapls$Data_Intervention$setAge,
			_halcwb$genapls$Data_Intervention$Month,
			months,
			A3(_halcwb$genapls$Data_Intervention$setAge, _halcwb$genapls$Data_Intervention$Year, years, _halcwb$genapls$Data_Intervention$model)));
	return _halcwb$genapls$Data_Intervention$calculate(initModel);
};
...
var _jpagex$elm_material_color$MaterialColor$blueGrey900 = A3(_elm_lang$core$Color$rgb, 38, 50, 56);
var _jpagex$elm_material_color$MaterialColor$blueGrey800 = A3(_elm_lang$core$Color$rgb, 55, 71, 79);
var _jpagex$elm_material_color$MaterialColor$blueGrey700 = A3(_elm_lang$core$Color$rgb, 69, 90, 100);
var _jpagex$elm_material_color$MaterialColor$blueGrey600 = A3(_elm_lang$core$Color$rgb, 84, 110, 122);
var _jpagex$elm_material_color$MaterialColor$blueGrey500 = A3(_elm_lang$core$Color$rgb, 96, 125, 139);
var _jpagex$elm_material_color$MaterialColor$blueGrey400 = A3(_elm_lang$core$Color$rgb, 120, 144, 156);
var _jpagex$elm_material_color$MaterialColor$blueGrey300 = A3(_elm_lang$core$Color$rgb, 144, 164, 174);
var _jpagex$elm_material_color$MaterialColor$blueGrey200 = A3(_elm_lang$core$Color$rgb, 176, 190, 197);
var _jpagex$elm_material_color$MaterialColor$blueGrey100 = A3(_elm_lang$core$Color$rgb, 207, 216, 220);
var _jpagex$elm_material_color$MaterialColor$blueGrey50 = A3(_elm_lang$core$Color$rgb, 236, 239, 241);
var _jpagex$elm_material_color$MaterialColor$grey900 = A3(_elm_lang$core$Color$rgb, 33, 33, 33);
var _jpagex$elm_material_color$MaterialColor$grey800 = A3(_elm_lang$core$Color$rgb, 66, 66, 66);
var _jpagex$elm_material_color$MaterialColor$grey700 = A3(_elm_lang$core$Color$rgb, 97, 97, 97);
var _jpagex$elm_material_color$MaterialColor$grey600 = A3(_elm_lang$core$Color$rgb, 117, 117, 117);
var _jpagex$elm_material_color$MaterialColor$grey500 = A3(_elm_lang$core$Color$rgb, 158, 158, 158);
var _jpagex$elm_material_color$MaterialColor$grey400 = A3(_elm_lang$core$Color$rgb, 189, 189, 189);
var _jpagex$elm_material_color$MaterialColor$grey300 = A3(_elm_lang$core$Color$rgb, 224, 224, 224);
var _jpagex$elm_material_color$MaterialColor$grey200 = A3(_elm_lang$core$Color$rgb, 238, 238, 238);
var _jpagex$elm_material_color$MaterialColor$grey100 = A3(_elm_lang$core$Color$rgb, 245, 245, 245);
var _jpagex$elm_material_color$MaterialColor$grey50 = A3(_elm_lang$core$Color$rgb, 250, 250, 250);
var _jpagex$elm_material_color$MaterialColor$brown900 = A3(_elm_lang$core$Color$rgb, 62, 39, 35);
var _jpagex$elm_material_color$MaterialColor$brown800 = A3(_elm_lang$core$Color$rgb, 78, 52, 46);
var _jpagex$elm_material_color$MaterialColor$brown700 = A3(_elm_lang$core$Color$rgb, 93, 64, 55);
var _jpagex$elm_material_color$MaterialColor$brown600 = A3(_elm_lang$core$Color$rgb, 109, 76, 65);
var _jpagex$elm_material_color$MaterialColor$brown500 = A3(_elm_lang$core$Color$rgb, 121, 85, 72);
var _jpagex$elm_material_color$MaterialColor$brown400 = A3(_elm_lang$core$Color$rgb, 141, 110, 99);
var _jpagex$elm_material_color$MaterialColor$brown300 = A3(_elm_lang$core$Color$rgb, 161, 136, 127);
var _jpagex$elm_material_color$MaterialColor$brown200 = A3(_elm_lang$core$Color$rgb, 188, 170, 164);
var _jpagex$elm_material_color$MaterialColor$brown100 = A3(_elm_lang$core$Color$rgb, 215, 204, 200);
var _jpagex$elm_material_color$MaterialColor$brown50 = A3(_elm_lang$core$Color$rgb, 239, 235, 233);
var _jpagex$elm_material_color$MaterialColor$deepOrangeA700 = A3(_elm_lang$core$Color$rgb, 221, 44, 0);
var _jpagex$elm_material_color$MaterialColor$deepOrangeA400 = A3(_elm_lang$core$Color$rgb, 255, 61, 0);
var _jpagex$elm_material_color$MaterialColor$deepOrangeA200 = A3(_elm_lang$core$Color$rgb, 255, 110, 64);
var _jpagex$elm_material_color$MaterialColor$deepOrangeA100 = A3(_elm_lang$core$Color$rgb, 255, 158, 128);
var _jpagex$elm_material_color$MaterialColor$deepOrange900 = A3(_elm_lang$core$Color$rgb, 191, 54, 12);
var _jpagex$elm_material_color$MaterialColor$deepOrange800 = A3(_elm_lang$core$Color$rgb, 216, 67, 21);
var _jpagex$elm_material_color$MaterialColor$deepOrange700 = A3(_elm_lang$core$Color$rgb, 230, 74, 25);
var _jpagex$elm_material_color$MaterialColor$deepOrange600 = A3(_elm_lang$core$Color$rgb, 244, 81, 30);
var _jpagex$elm_material_color$MaterialColor$deepOrange500 = A3(_elm_lang$core$Color$rgb, 255, 87, 34);
var _jpagex$elm_material_color$MaterialColor$deepOrange400 = A3(_elm_lang$core$Color$rgb, 255, 112, 67);
var _jpagex$elm_material_color$MaterialColor$deepOrange300 = A3(_elm_lang$core$Color$rgb, 255, 138, 101);
var _jpagex$elm_material_color$MaterialColor$deepOrange200 = A3(_elm_lang$core$Color$rgb, 255, 171, 145);
var _jpagex$elm_material_color$MaterialColor$deepOrange100 = A3(_elm_lang$core$Color$rgb, 255, 204, 188);
var _jpagex$elm_material_color$MaterialColor$deepOrange50 = A3(_elm_lang$core$Color$rgb, 251, 233, 231);
var _jpagex$elm_material_color$MaterialColor$orangeA700 = A3(_elm_lang$core$Color$rgb, 255, 109, 0);
var _jpagex$elm_material_color$MaterialColor$orangeA400 = A3(_elm_lang$core$Color$rgb, 255, 145, 0);
var _jpagex$elm_material_color$MaterialColor$orangeA200 = A3(_elm_lang$core$Color$rgb, 255, 171, 64);
var _jpagex$elm_material_color$MaterialColor$orangeA100 = A3(_elm_lang$core$Color$rgb, 255, 209, 128);
var _jpagex$elm_material_color$MaterialColor$orange900 = A3(_elm_lang$core$Color$rgb, 230, 81, 0);
var _jpagex$elm_material_color$MaterialColor$orange800 = A3(_elm_lang$core$Color$rgb, 239, 108, 0);
var _jpagex$elm_material_color$MaterialColor$orange700 = A3(_elm_lang$core$Color$rgb, 245, 124, 0);
var _jpagex$elm_material_color$MaterialColor$orange600 = A3(_elm_lang$core$Color$rgb, 251, 140, 0);
var _jpagex$elm_material_color$MaterialColor$orange500 = A3(_elm_lang$core$Color$rgb, 255, 152, 0);
var _jpagex$elm_material_color$MaterialColor$orange400 = A3(_elm_lang$core$Color$rgb, 255, 167, 38);
var _jpagex$elm_material_color$MaterialColor$orange300 = A3(_elm_lang$core$Color$rgb, 255, 183, 77);
var _jpagex$elm_material_color$MaterialColor$orange200 = A3(_elm_lang$core$Color$rgb, 255, 204, 128);
var _jpagex$elm_material_color$MaterialColor$orange100 = A3(_elm_lang$core$Color$rgb, 255, 224, 178);
var _jpagex$elm_material_color$MaterialColor$orange50 = A3(_elm_lang$core$Color$rgb, 255, 243, 224);
var _jpagex$elm_material_color$MaterialColor$amberA700 = A3(_elm_lang$core$Color$rgb, 255, 171, 0);
var _jpagex$elm_material_color$MaterialColor$amberA400 = A3(_elm_lang$core$Color$rgb, 255, 196, 0);
var _jpagex$elm_material_color$MaterialColor$amberA200 = A3(_elm_lang$core$Color$rgb, 255, 215, 64);
var _jpagex$elm_material_color$MaterialColor$amberA100 = A3(_elm_lang$core$Color$rgb, 255, 229, 127);
var _jpagex$elm_material_color$MaterialColor$amber900 = A3(_elm_lang$core$Color$rgb, 255, 111, 0);
var _jpagex$elm_material_color$MaterialColor$amber800 = A3(_elm_lang$core$Color$rgb, 255, 143, 0);
var _jpagex$elm_material_color$MaterialColor$amber700 = A3(_elm_lang$core$Color$rgb, 255, 160, 0);
var _jpagex$elm_material_color$MaterialColor$amber600 = A3(_elm_lang$core$Color$rgb, 255, 179, 0);
var _jpagex$elm_material_color$MaterialColor$amber500 = A3(_elm_lang$core$Color$rgb, 255, 193, 7);
var _jpagex$elm_material_color$MaterialColor$amber400 = A3(_elm_lang$core$Color$rgb, 255, 202, 40);
var _jpagex$elm_material_color$MaterialColor$amber300 = A3(_elm_lang$core$Color$rgb, 255, 213, 79);
var _jpagex$elm_material_color$MaterialColor$amber200 = A3(_elm_lang$core$Color$rgb, 255, 224, 130);
var _jpagex$elm_material_color$MaterialColor$amber100 = A3(_elm_lang$core$Color$rgb, 255, 236, 179);
var _jpagex$elm_material_color$MaterialColor$amber50 = A3(_elm_lang$core$Color$rgb, 255, 248, 225);
var _jpagex$elm_material_color$MaterialColor$yellowA700 = A3(_elm_lang$core$Color$rgb, 255, 214, 0);
var _jpagex$elm_material_color$MaterialColor$yellowA400 = A3(_elm_lang$core$Color$rgb, 255, 234, 0);
var _jpagex$elm_material_color$MaterialColor$yellowA200 = A3(_elm_lang$core$Color$rgb, 255, 255, 0);
var _jpagex$elm_material_color$MaterialColor$yellowA100 = A3(_elm_lang$core$Color$rgb, 255, 255, 141);
var _jpagex$elm_material_color$MaterialColor$yellow900 = A3(_elm_lang$core$Color$rgb, 245, 127, 23);
var _jpagex$elm_material_color$MaterialColor$yellow800 = A3(_elm_lang$core$Color$rgb, 249, 168, 37);
var _jpagex$elm_material_color$MaterialColor$yellow700 = A3(_elm_lang$core$Color$rgb, 251, 192, 45);
var _jpagex$elm_material_color$MaterialColor$yellow600 = A3(_elm_lang$core$Color$rgb, 253, 216, 53);
var _jpagex$elm_material_color$MaterialColor$yellow500 = A3(_elm_lang$core$Color$rgb, 255, 235, 59);
var _jpagex$elm_material_color$MaterialColor$yellow400 = A3(_elm_lang$core$Color$rgb, 255, 238, 88);
var _jpagex$elm_material_color$MaterialColor$yellow300 = A3(_elm_lang$core$Color$rgb, 255, 241, 118);
var _jpagex$elm_material_color$MaterialColor$yellow200 = A3(_elm_lang$core$Color$rgb, 255, 245, 157);
var _jpagex$elm_material_color$MaterialColor$yellow100 = A3(_elm_lang$core$Color$rgb, 255, 249, 196);
var _jpagex$elm_material_color$MaterialColor$yellow50 = A3(_elm_lang$core$Color$rgb, 255, 253, 231);
var _jpagex$elm_material_color$MaterialColor$limeA700 = A3(_elm_lang$core$Color$rgb, 174, 234, 0);
var _jpagex$elm_material_color$MaterialColor$limeA400 = A3(_elm_lang$core$Color$rgb, 198, 255, 0);
var _jpagex$elm_material_color$MaterialColor$limeA200 = A3(_elm_lang$core$Color$rgb, 238, 255, 65);
var _jpagex$elm_material_color$MaterialColor$limeA100 = A3(_elm_lang$core$Color$rgb, 244, 255, 129);
var _jpagex$elm_material_color$MaterialColor$lime900 = A3(_elm_lang$core$Color$rgb, 130, 119, 23);
var _jpagex$elm_material_color$MaterialColor$lime800 = A3(_elm_lang$core$Color$rgb, 158, 157, 36);
var _jpagex$elm_material_color$MaterialColor$lime700 = A3(_elm_lang$core$Color$rgb, 175, 180, 43);
var _jpagex$elm_material_color$MaterialColor$lime600 = A3(_elm_lang$core$Color$rgb, 192, 202, 51);
var _jpagex$elm_material_color$MaterialColor$lime500 = A3(_elm_lang$core$Color$rgb, 205, 220, 57);
var _jpagex$elm_material_color$MaterialColor$lime400 = A3(_elm_lang$core$Color$rgb, 212, 225, 87);
var _jpagex$elm_material_color$MaterialColor$lime300 = A3(_elm_lang$core$Color$rgb, 220, 231, 117);
var _jpagex$elm_material_color$MaterialColor$lime200 = A3(_elm_lang$core$Color$rgb, 230, 238, 156);
var _jpagex$elm_material_color$MaterialColor$lime100 = A3(_elm_lang$core$Color$rgb, 240, 244, 195);
var _jpagex$elm_material_color$MaterialColor$lime50 = A3(_elm_lang$core$Color$rgb, 249, 251, 231);
var _jpagex$elm_material_color$MaterialColor$lightGreenA700 = A3(_elm_lang$core$Color$rgb, 100, 221, 23);
var _jpagex$elm_material_color$MaterialColor$lightGreenA400 = A3(_elm_lang$core$Color$rgb, 118, 255, 3);
var _jpagex$elm_material_color$MaterialColor$lightGreenA200 = A3(_elm_lang$core$Color$rgb, 178, 255, 89);
var _jpagex$elm_material_color$MaterialColor$lightGreenA100 = A3(_elm_lang$core$Color$rgb, 204, 255, 144);
var _jpagex$elm_material_color$MaterialColor$lightGreen900 = A3(_elm_lang$core$Color$rgb, 51, 105, 30);
var _jpagex$elm_material_color$MaterialColor$lightGreen800 = A3(_elm_lang$core$Color$rgb, 85, 139, 47);
var _jpagex$elm_material_color$MaterialColor$lightGreen700 = A3(_elm_lang$core$Color$rgb, 104, 159, 56);
var _jpagex$elm_material_color$MaterialColor$lightGreen600 = A3(_elm_lang$core$Color$rgb, 124, 179, 66);
var _jpagex$elm_material_color$MaterialColor$lightGreen500 = A3(_elm_lang$core$Color$rgb, 139, 195, 74);
var _jpagex$elm_material_color$MaterialColor$lightGreen400 = A3(_elm_lang$core$Color$rgb, 156, 204, 101);
var _jpagex$elm_material_color$MaterialColor$lightGreen300 = A3(_elm_lang$core$Color$rgb, 174, 213, 129);
var _jpagex$elm_material_color$MaterialColor$lightGreen200 = A3(_elm_lang$core$Color$rgb, 197, 225, 165);
var _jpagex$elm_material_color$MaterialColor$lightGreen100 = A3(_elm_lang$core$Color$rgb, 220, 237, 200);
var _jpagex$elm_material_color$MaterialColor$lightGreen50 = A3(_elm_lang$core$Color$rgb, 241, 248, 233);
var _jpagex$elm_material_color$MaterialColor$greenA700 = A3(_elm_lang$core$Color$rgb, 0, 200, 83);
var _jpagex$elm_material_color$MaterialColor$greenA400 = A3(_elm_lang$core$Color$rgb, 0, 230, 118);
var _jpagex$elm_material_color$MaterialColor$greenA200 = A3(_elm_lang$core$Color$rgb, 105, 240, 174);
var _jpagex$elm_material_color$MaterialColor$greenA100 = A3(_elm_lang$core$Color$rgb, 185, 246, 202);
var _jpagex$elm_material_color$MaterialColor$green900 = A3(_elm_lang$core$Color$rgb, 27, 94, 32);
var _jpagex$elm_material_color$MaterialColor$green800 = A3(_elm_lang$core$Color$rgb, 46, 125, 50);
var _jpagex$elm_material_color$MaterialColor$green700 = A3(_elm_lang$core$Color$rgb, 56, 142, 60);
var _jpagex$elm_material_color$MaterialColor$green600 = A3(_elm_lang$core$Color$rgb, 67, 160, 71);
var _jpagex$elm_material_color$MaterialColor$green500 = A3(_elm_lang$core$Color$rgb, 76, 175, 80);
var _jpagex$elm_material_color$MaterialColor$green400 = A3(_elm_lang$core$Color$rgb, 102, 187, 106);
var _jpagex$elm_material_color$MaterialColor$green300 = A3(_elm_lang$core$Color$rgb, 129, 199, 132);
var _jpagex$elm_material_color$MaterialColor$green200 = A3(_elm_lang$core$Color$rgb, 165, 214, 167);
var _jpagex$elm_material_color$MaterialColor$green100 = A3(_elm_lang$core$Color$rgb, 200, 230, 201);
var _jpagex$elm_material_color$MaterialColor$green50 = A3(_elm_lang$core$Color$rgb, 232, 245, 233);
var _jpagex$elm_material_color$MaterialColor$tealA700 = A3(_elm_lang$core$Color$rgb, 0, 191, 165);
var _jpagex$elm_material_color$MaterialColor$tealA400 = A3(_elm_lang$core$Color$rgb, 29, 233, 182);
var _jpagex$elm_material_color$MaterialColor$tealA200 = A3(_elm_lang$core$Color$rgb, 100, 255, 218);
var _jpagex$elm_material_color$MaterialColor$tealA100 = A3(_elm_lang$core$Color$rgb, 167, 255, 235);
var _jpagex$elm_material_color$MaterialColor$teal900 = A3(_elm_lang$core$Color$rgb, 0, 77, 64);
var _jpagex$elm_material_color$MaterialColor$teal800 = A3(_elm_lang$core$Color$rgb, 0, 105, 92);
var _jpagex$elm_material_color$MaterialColor$teal700 = A3(_elm_lang$core$Color$rgb, 0, 121, 107);
var _jpagex$elm_material_color$MaterialColor$teal600 = A3(_elm_lang$core$Color$rgb, 0, 137, 123);
var _jpagex$elm_material_color$MaterialColor$teal500 = A3(_elm_lang$core$Color$rgb, 0, 150, 136);
var _jpagex$elm_material_color$MaterialColor$teal400 = A3(_elm_lang$core$Color$rgb, 38, 166, 154);
var _jpagex$elm_material_color$MaterialColor$teal300 = A3(_elm_lang$core$Color$rgb, 77, 182, 172);
var _jpagex$elm_material_color$MaterialColor$teal200 = A3(_elm_lang$core$Color$rgb, 128, 203, 196);
var _jpagex$elm_material_color$MaterialColor$teal100 = A3(_elm_lang$core$Color$rgb, 178, 223, 219);
var _jpagex$elm_material_color$MaterialColor$teal50 = A3(_elm_lang$core$Color$rgb, 224, 242, 241);
var _jpagex$elm_material_color$MaterialColor$cyanA700 = A3(_elm_lang$core$Color$rgb, 0, 184, 212);
var _jpagex$elm_material_color$MaterialColor$cyanA400 = A3(_elm_lang$core$Color$rgb, 0, 229, 255);
var _jpagex$elm_material_color$MaterialColor$cyanA200 = A3(_elm_lang$core$Color$rgb, 24, 255, 255);
var _jpagex$elm_material_color$MaterialColor$cyanA100 = A3(_elm_lang$core$Color$rgb, 132, 255, 255);
var _jpagex$elm_material_color$MaterialColor$cyan900 = A3(_elm_lang$core$Color$rgb, 0, 96, 100);
var _jpagex$elm_material_color$MaterialColor$cyan800 = A3(_elm_lang$core$Color$rgb, 0, 131, 143);
var _jpagex$elm_material_color$MaterialColor$cyan700 = A3(_elm_lang$core$Color$rgb, 0, 151, 167);
var _jpagex$elm_material_color$MaterialColor$cyan600 = A3(_elm_lang$core$Color$rgb, 0, 172, 193);
var _jpagex$elm_material_color$MaterialColor$cyan500 = A3(_elm_lang$core$Color$rgb, 0, 188, 212);
var _jpagex$elm_material_color$MaterialColor$cyan400 = A3(_elm_lang$core$Color$rgb, 38, 198, 218);
var _jpagex$elm_material_color$MaterialColor$cyan300 = A3(_elm_lang$core$Color$rgb, 77, 208, 225);
var _jpagex$elm_material_color$MaterialColor$cyan200 = A3(_elm_lang$core$Color$rgb, 128, 222, 234);
var _jpagex$elm_material_color$MaterialColor$cyan100 = A3(_elm_lang$core$Color$rgb, 178, 235, 242);
var _jpagex$elm_material_color$MaterialColor$cyan50 = A3(_elm_lang$core$Color$rgb, 224, 247, 250);
var _jpagex$elm_material_color$MaterialColor$lightBlueA700 = A3(_elm_lang$core$Color$rgb, 0, 145, 234);
var _jpagex$elm_material_color$MaterialColor$lightBlueA400 = A3(_elm_lang$core$Color$rgb, 0, 176, 255);
var _jpagex$elm_material_color$MaterialColor$lightBlueA200 = A3(_elm_lang$core$Color$rgb, 64, 196, 255);
var _jpagex$elm_material_color$MaterialColor$lightBlueA100 = A3(_elm_lang$core$Color$rgb, 128, 216, 255);
var _jpagex$elm_material_color$MaterialColor$lightBlue900 = A3(_elm_lang$core$Color$rgb, 1, 87, 155);
var _jpagex$elm_material_color$MaterialColor$lightBlue800 = A3(_elm_lang$core$Color$rgb, 2, 119, 189);
var _jpagex$elm_material_color$MaterialColor$lightBlue700 = A3(_elm_lang$core$Color$rgb, 2, 136, 209);
var _jpagex$elm_material_color$MaterialColor$lightBlue600 = A3(_elm_lang$core$Color$rgb, 3, 155, 229);
var _jpagex$elm_material_color$MaterialColor$lightBlue500 = A3(_elm_lang$core$Color$rgb, 3, 169, 244);
var _jpagex$elm_material_color$MaterialColor$lightBlue400 = A3(_elm_lang$core$Color$rgb, 41, 182, 246);
var _jpagex$elm_material_color$MaterialColor$lightBlue300 = A3(_elm_lang$core$Color$rgb, 79, 195, 247);
var _jpagex$elm_material_color$MaterialColor$lightBlue200 = A3(_elm_lang$core$Color$rgb, 129, 212, 250);
var _jpagex$elm_material_color$MaterialColor$lightBlue100 = A3(_elm_lang$core$Color$rgb, 179, 229, 252);
var _jpagex$elm_material_color$MaterialColor$lightBlue50 = A3(_elm_lang$core$Color$rgb, 225, 245, 254);
var _jpagex$elm_material_color$MaterialColor$blueA700 = A3(_elm_lang$core$Color$rgb, 41, 98, 255);
var _jpagex$elm_material_color$MaterialColor$blueA400 = A3(_elm_lang$core$Color$rgb, 41, 121, 255);
var _jpagex$elm_material_color$MaterialColor$blueA200 = A3(_elm_lang$core$Color$rgb, 68, 138, 255);
var _jpagex$elm_material_color$MaterialColor$blueA100 = A3(_elm_lang$core$Color$rgb, 130, 177, 255);
var _jpagex$elm_material_color$MaterialColor$blue900 = A3(_elm_lang$core$Color$rgb, 13, 71, 161);
var _jpagex$elm_material_color$MaterialColor$blue800 = A3(_elm_lang$core$Color$rgb, 21, 101, 192);
var _jpagex$elm_material_color$MaterialColor$blue700 = A3(_elm_lang$core$Color$rgb, 25, 118, 210);
var _jpagex$elm_material_color$MaterialColor$blue600 = A3(_elm_lang$core$Color$rgb, 30, 136, 229);
var _jpagex$elm_material_color$MaterialColor$blue500 = A3(_elm_lang$core$Color$rgb, 33, 150, 243);
var _jpagex$elm_material_color$MaterialColor$blue400 = A3(_elm_lang$core$Color$rgb, 66, 165, 245);
var _jpagex$elm_material_color$MaterialColor$blue300 = A3(_elm_lang$core$Color$rgb, 100, 181, 246);
var _jpagex$elm_material_color$MaterialColor$blue200 = A3(_elm_lang$core$Color$rgb, 144, 202, 249);
var _jpagex$elm_material_color$MaterialColor$blue100 = A3(_elm_lang$core$Color$rgb, 187, 222, 251);
var _jpagex$elm_material_color$MaterialColor$blue50 = A3(_elm_lang$core$Color$rgb, 227, 242, 253);
var _jpagex$elm_material_color$MaterialColor$indigoA700 = A3(_elm_lang$core$Color$rgb, 48, 79, 254);
var _jpagex$elm_material_color$MaterialColor$indigoA400 = A3(_elm_lang$core$Color$rgb, 61, 90, 254);
var _jpagex$elm_material_color$MaterialColor$indigoA200 = A3(_elm_lang$core$Color$rgb, 83, 109, 254);
var _jpagex$elm_material_color$MaterialColor$indigoA100 = A3(_elm_lang$core$Color$rgb, 140, 158, 255);
var _jpagex$elm_material_color$MaterialColor$indigo900 = A3(_elm_lang$core$Color$rgb, 26, 35, 126);
var _jpagex$elm_material_color$MaterialColor$indigo800 = A3(_elm_lang$core$Color$rgb, 40, 53, 147);
var _jpagex$elm_material_color$MaterialColor$indigo700 = A3(_elm_lang$core$Color$rgb, 48, 63, 159);
var _jpagex$elm_material_color$MaterialColor$indigo600 = A3(_elm_lang$core$Color$rgb, 57, 73, 171);
var _jpagex$elm_material_color$MaterialColor$indigo500 = A3(_elm_lang$core$Color$rgb, 63, 81, 181);
var _jpagex$elm_material_color$MaterialColor$indigo400 = A3(_elm_lang$core$Color$rgb, 92, 107, 192);
var _jpagex$elm_material_color$MaterialColor$indigo300 = A3(_elm_lang$core$Color$rgb, 121, 134, 203);
var _jpagex$elm_material_color$MaterialColor$indigo200 = A3(_elm_lang$core$Color$rgb, 159, 168, 218);
var _jpagex$elm_material_color$MaterialColor$indigo100 = A3(_elm_lang$core$Color$rgb, 197, 202, 233);
var _jpagex$elm_material_color$MaterialColor$indigo50 = A3(_elm_lang$core$Color$rgb, 232, 234, 246);
var _jpagex$elm_material_color$MaterialColor$deepPurpleA700 = A3(_elm_lang$core$Color$rgb, 98, 0, 234);
var _jpagex$elm_material_color$MaterialColor$deepPurpleA400 = A3(_elm_lang$core$Color$rgb, 101, 31, 255);
var _jpagex$elm_material_color$MaterialColor$deepPurpleA200 = A3(_elm_lang$core$Color$rgb, 124, 77, 255);
var _jpagex$elm_material_color$MaterialColor$deepPurpleA100 = A3(_elm_lang$core$Color$rgb, 179, 136, 255);
var _jpagex$elm_material_color$MaterialColor$deepPurple900 = A3(_elm_lang$core$Color$rgb, 49, 27, 146);
var _jpagex$elm_material_color$MaterialColor$deepPurple800 = A3(_elm_lang$core$Color$rgb, 69, 39, 160);
var _jpagex$elm_material_color$MaterialColor$deepPurple700 = A3(_elm_lang$core$Color$rgb, 81, 45, 168);
var _jpagex$elm_material_color$MaterialColor$deepPurple600 = A3(_elm_lang$core$Color$rgb, 94, 53, 177);
var _jpagex$elm_material_color$MaterialColor$deepPurple500 = A3(_elm_lang$core$Color$rgb, 103, 58, 183);
var _jpagex$elm_material_color$MaterialColor$deepPurple400 = A3(_elm_lang$core$Color$rgb, 126, 87, 194);
var _jpagex$elm_material_color$MaterialColor$deepPurple300 = A3(_elm_lang$core$Color$rgb, 149, 117, 205);
var _jpagex$elm_material_color$MaterialColor$deepPurple200 = A3(_elm_lang$core$Color$rgb, 179, 157, 219);
var _jpagex$elm_material_color$MaterialColor$deepPurple100 = A3(_elm_lang$core$Color$rgb, 209, 196, 233);
var _jpagex$elm_material_color$MaterialColor$deepPurple50 = A3(_elm_lang$core$Color$rgb, 237, 231, 246);
var _jpagex$elm_material_color$MaterialColor$purpleA700 = A3(_elm_lang$core$Color$rgb, 170, 0, 255);
var _jpagex$elm_material_color$MaterialColor$purpleA400 = A3(_elm_lang$core$Color$rgb, 213, 0, 249);
var _jpagex$elm_material_color$MaterialColor$purpleA200 = A3(_elm_lang$core$Color$rgb, 224, 64, 251);
var _jpagex$elm_material_color$MaterialColor$purpleA100 = A3(_elm_lang$core$Color$rgb, 234, 128, 252);
var _jpagex$elm_material_color$MaterialColor$purple900 = A3(_elm_lang$core$Color$rgb, 74, 20, 140);
var _jpagex$elm_material_color$MaterialColor$purple800 = A3(_elm_lang$core$Color$rgb, 106, 27, 154);
var _jpagex$elm_material_color$MaterialColor$purple700 = A3(_elm_lang$core$Color$rgb, 123, 31, 162);
var _jpagex$elm_material_color$MaterialColor$purple600 = A3(_elm_lang$core$Color$rgb, 142, 36, 170);
var _jpagex$elm_material_color$MaterialColor$purple500 = A3(_elm_lang$core$Color$rgb, 156, 39, 176);
var _jpagex$elm_material_color$MaterialColor$purple400 = A3(_elm_lang$core$Color$rgb, 171, 71, 188);
var _jpagex$elm_material_color$MaterialColor$purple300 = A3(_elm_lang$core$Color$rgb, 186, 104, 200);
var _jpagex$elm_material_color$MaterialColor$purple200 = A3(_elm_lang$core$Color$rgb, 206, 147, 216);
var _jpagex$elm_material_color$MaterialColor$purple100 = A3(_elm_lang$core$Color$rgb, 225, 190, 231);
var _jpagex$elm_material_color$MaterialColor$purple50 = A3(_elm_lang$core$Color$rgb, 243, 229, 245);
var _jpagex$elm_material_color$MaterialColor$pinkA700 = A3(_elm_lang$core$Color$rgb, 197, 17, 98);
var _jpagex$elm_material_color$MaterialColor$pinkA400 = A3(_elm_lang$core$Color$rgb, 245, 0, 87);
var _jpagex$elm_material_color$MaterialColor$pinkA200 = A3(_elm_lang$core$Color$rgb, 255, 64, 129);
var _jpagex$elm_material_color$MaterialColor$pinkA100 = A3(_elm_lang$core$Color$rgb, 255, 128, 171);
var _jpagex$elm_material_color$MaterialColor$pink900 = A3(_elm_lang$core$Color$rgb, 136, 14, 79);
var _jpagex$elm_material_color$MaterialColor$pink800 = A3(_elm_lang$core$Color$rgb, 173, 20, 87);
var _jpagex$elm_material_color$MaterialColor$pink700 = A3(_elm_lang$core$Color$rgb, 194, 24, 91);
var _jpagex$elm_material_color$MaterialColor$pink600 = A3(_elm_lang$core$Color$rgb, 216, 27, 96);
var _jpagex$elm_material_color$MaterialColor$pink500 = A3(_elm_lang$core$Color$rgb, 233, 30, 99);
var _jpagex$elm_material_color$MaterialColor$pink400 = A3(_elm_lang$core$Color$rgb, 236, 64, 122);
var _jpagex$elm_material_color$MaterialColor$pink300 = A3(_elm_lang$core$Color$rgb, 240, 98, 146);
var _jpagex$elm_material_color$MaterialColor$pink200 = A3(_elm_lang$core$Color$rgb, 244, 143, 177);
var _jpagex$elm_material_color$MaterialColor$pink100 = A3(_elm_lang$core$Color$rgb, 248, 187, 208);
var _jpagex$elm_material_color$MaterialColor$pink50 = A3(_elm_lang$core$Color$rgb, 252, 228, 236);
var _jpagex$elm_material_color$MaterialColor$redA700 = A3(_elm_lang$core$Color$rgb, 213, 0, 0);
var _jpagex$elm_material_color$MaterialColor$redA400 = A3(_elm_lang$core$Color$rgb, 255, 23, 68);
var _jpagex$elm_material_color$MaterialColor$redA200 = A3(_elm_lang$core$Color$rgb, 255, 82, 82);
var _jpagex$elm_material_color$MaterialColor$redA100 = A3(_elm_lang$core$Color$rgb, 255, 138, 128);
var _jpagex$elm_material_color$MaterialColor$red900 = A3(_elm_lang$core$Color$rgb, 183, 28, 28);
var _jpagex$elm_material_color$MaterialColor$red800 = A3(_elm_lang$core$Color$rgb, 198, 40, 40);
var _jpagex$elm_material_color$MaterialColor$red700 = A3(_elm_lang$core$Color$rgb, 211, 47, 47);
var _jpagex$elm_material_color$MaterialColor$red600 = A3(_elm_lang$core$Color$rgb, 229, 57, 53);
var _jpagex$elm_material_color$MaterialColor$red500 = A3(_elm_lang$core$Color$rgb, 244, 67, 54);
var _jpagex$elm_material_color$MaterialColor$red400 = A3(_elm_lang$core$Color$rgb, 239, 83, 80);
var _jpagex$elm_material_color$MaterialColor$red300 = A3(_elm_lang$core$Color$rgb, 229, 115, 115);
var _jpagex$elm_material_color$MaterialColor$red200 = A3(_elm_lang$core$Color$rgb, 239, 154, 154);
var _jpagex$elm_material_color$MaterialColor$red100 = A3(_elm_lang$core$Color$rgb, 255, 205, 210);
var _jpagex$elm_material_color$MaterialColor$red50 = A3(_elm_lang$core$Color$rgb, 255, 235, 238);
...
var _halcwb$genapls$GenStyle$fontSize = F3(
	function (size, min, max) {
		return A3(
			_mdgriffith$style_elements$Element$responsive,
			size,
			{ctor: '_Tuple2', _0: 320, _1: 2560},
			{ctor: '_Tuple2', _0: min, _1: max});
	});
var _halcwb$genapls$GenStyle$roboto = {
	ctor: '::',
	_0: _mdgriffith$style_elements$Style_Font$importUrl(
		{url: 'https://fonts.googleapis.com/css?family=Roboto', name: 'Roboto'}),
	_1: {ctor: '[]'}
};
var _halcwb$genapls$GenStyle$NotImportant = {ctor: 'NotImportant'};
var _halcwb$genapls$GenStyle$Important = {ctor: 'Important'};
var _halcwb$genapls$GenStyle$Footer = {ctor: 'Footer'};
var _halcwb$genapls$GenStyle$MenuItemSelected = {ctor: 'MenuItemSelected'};
var _halcwb$genapls$GenStyle$MenuItem = {ctor: 'MenuItem'};
var _halcwb$genapls$GenStyle$MenuContents = {ctor: 'MenuContents'};
var _halcwb$genapls$GenStyle$Title = {ctor: 'Title'};
var _halcwb$genapls$GenStyle$TableRowHover = {ctor: 'TableRowHover'};
var _halcwb$genapls$GenStyle$TableRow = {ctor: 'TableRow'};
var _halcwb$genapls$GenStyle$TableHead = {ctor: 'TableHead'};
var _halcwb$genapls$GenStyle$Button = {ctor: 'Button'};
var _halcwb$genapls$GenStyle$Select = {ctor: 'Select'};
var _halcwb$genapls$GenStyle$Label = {ctor: 'Label'};
var _halcwb$genapls$GenStyle$Input = {ctor: 'Input'};
var _halcwb$genapls$GenStyle$Header = {ctor: 'Header'};
var _halcwb$genapls$GenStyle$Main = {ctor: 'Main'};
var _halcwb$genapls$GenStyle$None = {ctor: 'None'};
var _halcwb$genapls$GenStyle$stylesheet = function (size) {
	var fs = _halcwb$genapls$GenStyle$fontSize(
	...
	return _mdgriffith$style_elements$Style$styleSheet(
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Font$typeface(_halcwb$genapls$GenStyle$roboto),
						_1: {
							ctor: '::',
							_0: A2(_mdgriffith$style_elements$Style$prop, 'overflow-x', 'hidden'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_halcwb$genapls$GenStyle$Header,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Color$background(_jpagex$elm_material_color$MaterialColor$teal800),
								_1: {
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_halcwb$genapls$GenStyle$Button,
							{
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Color$background(_jpagex$elm_material_color$MaterialColor$teal900),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_halcwb$genapls$GenStyle$Input,
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$size(16),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Color$text(_jpagex$elm_material_color$MaterialColor$teal900),
										_1: {
											ctor: '::',
											_0: _mdgriffith$style_elements$Style_Color$border(_jpagex$elm_material_color$MaterialColor$teal100),
											_1: {
												ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_mdgriffith$style_elements$Style$style,
									_halcwb$genapls$GenStyle$Select,
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Color$border(_jpagex$elm_material_color$MaterialColor$teal100),
										_1: {
								...
								_1: {
									...
									_0: A2(
										_mdgriffith$style_elements$Style$style,
										_halcwb$genapls$GenStyle$Label,
										{
											ctor: '::',
											_0: _mdgriffith$style_elements$Style_Color$text(_jpagex$elm_material_color$MaterialColor$teal400),
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Font$size(14),
												_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											_mdgriffith$style_elements$Style$style,
											_halcwb$genapls$GenStyle$TableHead,
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Color$text(
													A3(_elm_lang$core$Color$rgb, 158, 158, 158)),
												_1: {
													ctor: '::',
													_0: _mdgriffith$style_elements$Style_Font$size(13),
													_1: {
														ctor: '::',
														_0: _mdgriffith$style_elements$Style_Font$bold,
														_1: {
										...
										_1: {
											...
											_0: A2(
												_mdgriffith$style_elements$Style$style,
												_halcwb$genapls$GenStyle$TableRow,
												{
													ctor: '::',
													_0: _mdgriffith$style_elements$Style_Color$text(
														A3(_elm_lang$core$Color$rgb, 117, 117, 117)),
													_1: {
														ctor: '::',
														_0: _mdgriffith$style_elements$Style_Font$size(14),
														_1: {
											...
											_1: {
												...
												_0: A2(
													_mdgriffith$style_elements$Style$style,
													_halcwb$genapls$GenStyle$TableRowHover,
													{
														ctor: '::',
														_0: _mdgriffith$style_elements$Style_Font$size(14),
														_1: {
												...
												_1: {
													...
													_0: A2(
														_mdgriffith$style_elements$Style$style,
														_halcwb$genapls$GenStyle$Title,
														{
															ctor: '::',
															_0: _mdgriffith$style_elements$Style_Color$text(_jpagex$elm_material_color$MaterialColor$teal400),
															_1: {
													...
													_1: {
														...
														_0: A2(
															_mdgriffith$style_elements$Style$style,
															_halcwb$genapls$GenStyle$MenuContents,
															{
																ctor: '::',
																_0: _mdgriffith$style_elements$Style_Color$background(_elm_lang$core$Color$white),
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_1: {
																				ctor: '::',
																				_0: A2(_mdgriffith$style_elements$Style$prop, 'z-index', '8'),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
														...
														_1: {
															...
															_0: A2(
																_mdgriffith$style_elements$Style$style,
																_halcwb$genapls$GenStyle$MenuItem,
																{
																	ctor: '::',
																	_0: _mdgriffith$style_elements$Style$cursor('pointer'),
																	_1: {
															...
															_1: {
																...
																_0: A2(
																	_mdgriffith$style_elements$Style$style,
																	_halcwb$genapls$GenStyle$MenuItemSelected,
																	{
																		ctor: '::',
																		_0: _mdgriffith$style_elements$Style$cursor('pointer'),
																		_1: {
																...
																_1: {
																	...
																	_0: A2(
																		_mdgriffith$style_elements$Style$style,
																		_halcwb$genapls$GenStyle$Footer,
																		{
																			ctor: '::',
																			_0: _mdgriffith$style_elements$Style_Color$background(
																				A3(_elm_lang$core$Color$rgb, 66, 66, 66)),
																			_1: {
																				ctor: '::',
																				_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
																				_1: {
																	...
																	_1: {
																		...
																		_0: A2(
																			_mdgriffith$style_elements$Style$style,
																			_halcwb$genapls$GenStyle$Important,
																			{
																				ctor: '::',
																				_0: _mdgriffith$style_elements$Style_Font$bold,
																				_1: {ctor: '[]'}
...
var _halcwb$genapls$Page_EmergencyList$addPaddingTopBottom10 = function (attrs) {
	return A2(
		_elm_lang$core$List$append,
		{
			ctor: '::',
...
var _halcwb$genapls$Page_EmergencyList$updateModel = F2(
	function (s, model) {
		var model_ = _elm_lang$core$Native_Utils.eq(s, model.all) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				selections: {ctor: '[]'}
			}) : (A2(
			...
			model.selections) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				selections: A2(
					_elm_lang$core$List$filter,
					function (x) {
						return !_elm_lang$core$Native_Utils.eq(x, s);
					},
					model.selections)
			}) : _elm_lang$core$Native_Utils.update(
			model,
...
var _halcwb$genapls$Page_EmergencyList$calculate = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			interventions: _halcwb$genapls$Data_Intervention$calculate(model.interventions)
		});
};
var _halcwb$genapls$Page_EmergencyList$setWeight = F2(
	function (string, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				interventions: A2(_halcwb$genapls$Data_Intervention$setWeight, string, model.interventions)
			});
	});
var _halcwb$genapls$Page_EmergencyList$setAge = F3(
	function (age, string, model) {
		var age_ = function () {
			var _p0 = age;
			if (_p0.ctor === 'Year') {
				return _halcwb$genapls$Data_Intervention$Year;
			} else {
				return _halcwb$genapls$Data_Intervention$Month;
			}
		}();
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				interventions: A3(_halcwb$genapls$Data_Intervention$setAge, age_, string, model.interventions)
			});
	});
var _halcwb$genapls$Page_EmergencyList$updateCounter = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{counter: model.counter + 1});
};
var _halcwb$genapls$Page_EmergencyList$onClickPreventDefault = function (msg) {
	return A3(
...
var _halcwb$genapls$Page_EmergencyList$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {interventions: a, indications: b, selections: c, all: d, yearDropdown: e, monthDropdown: f, hoverRowIndx: g, menuState: h, counter: i};
	});
var _halcwb$genapls$Page_EmergencyList$Intervention = F6(
	function (a, b, c, d, e, f) {
		return {indication: a, intervention: b, value: c, preparation: d, solution: e, advice: f};
	});
var _halcwb$genapls$Page_EmergencyList$printEmergencyList = function (model) {
	var intervs = model.interventions;
	var meds = function () {
		var advice = function (m) {
			return _halcwb$genapls$Data_Medication$printAdvice(m);
		};
		var volume = function (m) {
			return _elm_lang$core$Tuple$second(
				_halcwb$genapls$Data_Medication$printDoseVolume(m));
		};
		var dosePerKg = function (m) {
			return A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 1, m.dose / intervs.weight);
		};
		var dose = function (m) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				function (_p1) {
					return _elm_lang$core$Tuple$first(
						_halcwb$genapls$Data_Medication$printDoseVolume(_p1));
				}(m),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' (',
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							A2(_elm_lang$core$Basics_ops['++'], m.unit, '/kg)')))));
		};
		return A2(
			_elm_lang$core$List$map,
			function (m) {
				return A6(
					_halcwb$genapls$Page_EmergencyList$Intervention,
					m.category,
					m.name,
					dose(m),
					volume(m),
	...
	var printCardioversionSnd = function (_p2) {
		return _elm_lang$core$Tuple$second(
			_halcwb$genapls$Data_Intervention$printCardioversion(_p2));
	};
	var printCardioversionFst = function (_p3) {
		return _elm_lang$core$Tuple$first(
			_halcwb$genapls$Data_Intervention$printCardioversion(_p3));
	};
	var printDefibrillationSnd = function (_p4) {
		return _elm_lang$core$Tuple$second(
			_halcwb$genapls$Data_Intervention$printDefibrillation(_p4));
	};
	var printDefibrillationFst = function (_p5) {
		return _elm_lang$core$Tuple$first(
			_halcwb$genapls$Data_Intervention$printDefibrillation(_p5));
	};
	var printFluidBolusSnd = function (_p6) {
		return _elm_lang$core$Tuple$second(
			_halcwb$genapls$Data_Intervention$printFluidBolus(_p6));
	};
	var printFluidBolusFst = function (_p7) {
		return _elm_lang$core$Tuple$first(
			_halcwb$genapls$Data_Intervention$printFluidBolus(_p7));
	};
	var printEpinephrineTrSnd = function (_p8) {
		return _elm_lang$core$Tuple$second(
			_halcwb$genapls$Data_Intervention$printEpinephrineTR(_p8));
	};
	var printEpinephrineTrFst = function (_p9) {
		return _elm_lang$core$Tuple$first(
			_halcwb$genapls$Data_Intervention$printEpinephrineTR(_p9));
	};
	var printEpinephrineIVSnd = function (_p10) {
		return _elm_lang$core$Tuple$second(
			_halcwb$genapls$Data_Intervention$printEpinephrineIV(_p10));
	};
	var printEpinephrineIVFst = function (_p11) {
		return _elm_lang$core$Tuple$first(
			_halcwb$genapls$Data_Intervention$printEpinephrineIV(_p11));
	};
	var printTubeLengthNasal = _halcwb$genapls$Data_Intervention$printTubeLengthNasal;
	var printTubeLengthOral = _halcwb$genapls$Data_Intervention$printTubeLengthOral;
	var printTubeSize = _halcwb$genapls$Data_Intervention$printTubeSize;
	return A2(
		_elm_lang$core$List$filter,
		function (m) {
			return _elm_lang$core$List$isEmpty(model.selections) || A2(
				_elm_lang$core$List$any,
				F2(
					function (x, y) {
						return _elm_lang$core$Native_Utils.eq(x, y);
					...
					_1: {
						...
						_1: {
							...
							_0: A6(
								...
								'reanimatie',
								'epinephrine iv/io',
								printEpinephrineIVFst(intervs),
								printEpinephrineIVSnd(intervs),
								'',
								'0,01 mg/kg iv'),
							_1: {
								ctor: '::',
								_0: A6(
									_halcwb$genapls$Page_EmergencyList$Intervention,
									'reanimatie',
									'epinephrine tracheaal',
									printEpinephrineTrFst(intervs),
									printEpinephrineTrSnd(intervs),
									'',
									'0,1 mg/kg trach'),
								_1: {
									ctor: '::',
									_0: A6(
										...
										'reanimatie',
										'vaat vulling',
										printFluidBolusFst(intervs),
										printFluidBolusSnd(intervs),
										'',
										'20 ml/kg'),
									_1: {
										ctor: '::',
										_0: A6(
											...
											'reanimatie',
											'defibrillatie',
											printDefibrillationFst(intervs),
											printDefibrillationSnd(intervs),
											'',
											'4 Joule/kg'),
										_1: {
											ctor: '::',
											_0: A6(
												...
												'reanimatie',
												'cardioversie',
												printCardioversionFst(intervs),
												printCardioversionSnd(intervs),
												'',
												'2 Joule/kg'),
											_1: {ctor: '[]'}
										}
...
var _halcwb$genapls$Page_EmergencyList$Month = {ctor: 'Month'};
var _halcwb$genapls$Page_EmergencyList$Year = {ctor: 'Year'};
var _halcwb$genapls$Page_EmergencyList$MenuClosed = {ctor: 'MenuClosed'};
var _halcwb$genapls$Page_EmergencyList$MenuOpen = {ctor: 'MenuOpen'};
var _halcwb$genapls$Page_EmergencyList$SelectMenuItem = function (a) {
	return {ctor: 'SelectMenuItem', _0: a};
};
var _halcwb$genapls$Page_EmergencyList$CloseMenu = {ctor: 'CloseMenu'};
var _halcwb$genapls$Page_EmergencyList$ToggleMenu = {ctor: 'ToggleMenu'};
var _halcwb$genapls$Page_EmergencyList$TableRowLeave = {ctor: 'TableRowLeave'};
var _halcwb$genapls$Page_EmergencyList$TableRowEnter = function (a) {
	return {ctor: 'TableRowEnter', _0: a};
};
var _halcwb$genapls$Page_EmergencyList$Clear = {ctor: 'Clear'};
...
var _halcwb$genapls$Page_EmergencyList$body = F3(
	function (supportsGrid, model, device) {
		var oneColumn = F2(
			function (r, i) {
				...
				return A3(
					...
					style,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Events$onMouseEnter(
									_halcwb$genapls$Page_EmergencyList$TableRowEnter(i + 1)),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Events$onMouseLeave(_halcwb$genapls$Page_EmergencyList$TableRowLeave),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element$underline(r.indication),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element$bold(
								A2(
									_elm_lang$core$Basics_ops['++'],
									r.intervention,
									A2(_elm_lang$core$Basics_ops['++'], ' ', r.value))),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Native_Utils.eq(r.preparation, '') ? _mdgriffith$style_elements$Element$empty : A3(
									...
									},
									{
										...
										_0: _mdgriffith$style_elements$Element$text(
											A2(_elm_lang$core$Basics_ops['++'], 'bereiding: ', r.preparation)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Native_Utils.eq(r.solution, '') ? _mdgriffith$style_elements$Element$empty : _mdgriffith$style_elements$Element$text(r.solution),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Element$italic(
											A2(_elm_lang$core$Basics_ops['++'], 'advies: ', r.advice)),
										_1: {ctor: '[]'}
									}
								}
							}
		...
		var labelAbove = function (s) {
			return _mdgriffith$style_elements$Element_Input$labelAbove(
				A3(
					_mdgriffith$style_elements$Element$el,
					_halcwb$genapls$GenStyle$Label,
					{
		...
		var printList = _halcwb$genapls$Page_EmergencyList$printEmergencyList(model);
		var ageDropdown = F4(
			function (txt, min, max, dropDown) {
				return A3(
		...
		var yearDropdown = A4(ageDropdown, 'Leeftijd (jaren)', 0, 17, model.yearDropdown);
		var monthDropdown = A4(ageDropdown, 'Leeftijd (maanden)', 0, 11, model.monthDropdown);
		var tableHead = function (s) {
			return A3(
				_mdgriffith$style_elements$Element$el,
				_halcwb$genapls$GenStyle$TableHead,
				A2(
					_elm_lang$core$List$append,
					A2(_elm_lang$core$String$startsWith, 'Indicatie', s) ? {
						ctor: '::',
						_0: _halcwb$genapls$Page_EmergencyList$onClickPreventDefault(_halcwb$genapls$Page_EmergencyList$ToggleMenu),
						_1: {
							ctor: '::',
		...
		var tableMenu = function (s) {
			var map = function (item) {
				var style = (_elm_lang$core$List$isEmpty(model.selections) && _elm_lang$core$Native_Utils.eq(item, model.all)) ? _halcwb$genapls$GenStyle$MenuItemSelected : (A2(
					_elm_lang$core$List$any,
					F2(
						function (x, y) {
							return _elm_lang$core$Native_Utils.eq(x, y);
						})(item),
					model.selections) ? _halcwb$genapls$GenStyle$MenuItemSelected : _halcwb$genapls$GenStyle$MenuItem);
				return A3(
					_mdgriffith$style_elements$Element$el,
					style,
					{
						...
						_1: {
							ctor: '::',
							_0: _halcwb$genapls$Page_EmergencyList$onClickPreventDefault(
								_halcwb$genapls$Page_EmergencyList$SelectMenuItem(item)),
							_1: {ctor: '[]'}
						}
					},
					_mdgriffith$style_elements$Element$text(item));
			};
			var items = {ctor: '::', _0: model.all, _1: model.indications};
			var _p12 = model.menuState;
			if (_p12.ctor === 'MenuClosed') {
				return tableHead(
						...
						_0: A3(
							...
							_halcwb$genapls$GenStyle$MenuContents,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Element_Events$onMouseLeave(_halcwb$genapls$Page_EmergencyList$ToggleMenu),
										_1: {ctor: '[]'}
									}
								}
							},
							A2(_elm_lang$core$List$map, map, items)),
						_1: {ctor: '[]'}
					},
					tableHead(
						A2(_elm_lang$core$Basics_ops['++'], s, ' ▲')));
				...
				_1: {
					...
					_0: A3(
						...
						},
						{
							...
							_0: A3(
								...
								{
									onChange: _halcwb$genapls$Page_EmergencyList$UpdateWeight,
					...
					_1: {
						...
						_0: A3(
							...
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Events$onClick(_halcwb$genapls$Page_EmergencyList$Clear),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Attributes$padding(10),
									_1: {ctor: '[]'}
							...
							_mdgriffith$style_elements$Element$text('VERWIJDER')),
						_1: {ctor: '[]'}
					}
				}
			}) : A3(
		...
		var table = function () {
			var columns = {
				...
				_0: {
					...
					_0: tableMenu('Indicatie'),
					_1: A2(
						_halcwb$genapls$Util_ListUtils$mapi,
						function (_p13) {
							return tableCell(
								function (_) {
									return _.indication;
			...
			return (device.phone || (!supportsGrid)) ? A3(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: tableHead('Berekend'),
					_1: A2(_halcwb$genapls$Util_ListUtils$mapi, oneColumn, printList)
				}) : A3(
		...
		var tableTitle = (_elm_lang$core$Native_Utils.cmp(model.interventions.weight, 0) > 0) ? A2(
			_elm_lang$core$Basics_ops['++'],
			'Berekend op basis van gewicht: ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_halcwb$genapls$Util_FixPrecision$fixPrecision, 2, model.interventions.weight),
				' kg')) : 'Berekend op basis van gewicht: ';
		return A3(
			_mdgriffith$style_elements$Element$column,
			_halcwb$genapls$GenStyle$Main,
			{
			...
			},
			{
				...
				_1: {
					...
					_0: A3(
						_mdgriffith$style_elements$Element$paragraph,
						_halcwb$genapls$GenStyle$Title,
						_halcwb$genapls$Page_EmergencyList$addPaddingTopBottom10(
							{ctor: '[]'}),
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Element$text(tableTitle),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _halcwb$genapls$Page_EmergencyList$UpdateMonth = function (a) {
	return {ctor: 'UpdateMonth', _0: a};
};
var _halcwb$genapls$Page_EmergencyList$UpdateYear = function (a) {
	return {ctor: 'UpdateYear', _0: a};
};
var _halcwb$genapls$Page_EmergencyList$newModel = function () {
	var dropDown = function (msg) {
		return A2(_mdgriffith$style_elements$Element_Input$dropMenu, _elm_lang$core$Maybe$Nothing, msg);
	};
	var inds = _halcwb$genapls$Util_ListUtils$removeDuplicates(
		A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.category;
			},
			_halcwb$genapls$Data_Medication$medicationList));
	return {
		interventions: _halcwb$genapls$Data_Intervention$model,
		indications: inds,
		selections: {ctor: '[]'},
		all: 'alles',
		yearDropdown: dropDown(_halcwb$genapls$Page_EmergencyList$UpdateYear),
		monthDropdown: dropDown(_halcwb$genapls$Page_EmergencyList$UpdateMonth),
		hoverRowIndx: 0,
		menuState: _halcwb$genapls$Page_EmergencyList$MenuClosed,
		counter: 0
	};
}();
var _halcwb$genapls$Page_EmergencyList$update = F2(
	function (msg, model) {
		var updateAge = F3(
			function (age, selectMsg, menu) {
				var selMenu = A2(_mdgriffith$style_elements$Element_Input$updateSelection, selectMsg, menu);
				var selected = _mdgriffith$style_elements$Element_Input$selected(selMenu);
				var model_ = function () {
					var _p18 = selected;
					if (_p18.ctor === 'Just') {
						return _halcwb$genapls$Page_EmergencyList$calculate(
							A3(_halcwb$genapls$Page_EmergencyList$setAge, age, _p18._0, model));
					} else {
						return model;
					}
				}();
				return {ctor: '_Tuple2', _0: model_, _1: selMenu};
			});
		var _p19 = msg;
		switch (_p19.ctor) {
			case 'UpdateYear':
				var model_ = function () {
					var _p20 = A3(updateAge, _halcwb$genapls$Page_EmergencyList$Year, _p19._0, model.yearDropdown);
					var newModel = _p20._0;
					var selMenu = _p20._1;
					return _elm_lang$core$Native_Utils.update(
						newModel,
						{yearDropdown: selMenu});
				}();
				return {
					ctor: '_Tuple2',
					_0: _halcwb$genapls$Page_EmergencyList$updateCounter(model_),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateMonth':
				var model_ = function () {
					var _p21 = A3(updateAge, _halcwb$genapls$Page_EmergencyList$Month, _p19._0, model.monthDropdown);
					var newModel = _p21._0;
					var selMenu = _p21._1;
					return _elm_lang$core$Native_Utils.update(
						newModel,
						{monthDropdown: selMenu});
				}();
				return {
					ctor: '_Tuple2',
					_0: _halcwb$genapls$Page_EmergencyList$updateCounter(model_),
			...
			case 'UpdateWeight':
				var model_ = _halcwb$genapls$Page_EmergencyList$calculate(
					A2(_halcwb$genapls$Page_EmergencyList$setWeight, _p19._0, model));
				return {ctor: '_Tuple2', _0: model_, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Clear':
				return {ctor: '_Tuple2', _0: _halcwb$genapls$Page_EmergencyList$newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'TableRowEnter':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{hoverRowIndx: _p19._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TableRowLeave':
				return {
			...
			case 'ToggleMenu':
				var state = function () {
					var _p22 = model.menuState;
					if (_p22.ctor === 'MenuClosed') {
						return _halcwb$genapls$Page_EmergencyList$MenuOpen;
					} else {
						return _halcwb$genapls$Page_EmergencyList$MenuClosed;
					}
				}();
				return {
					ctor: '_Tuple2',
			...
			default:
				var model_ = A2(_halcwb$genapls$Page_EmergencyList$updateModel, _p19._0, model);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model_,
...
var _halcwb$genapls$Util_ElementUtils$responsivePadding = F4(
	function (pt, w, min, max) {
		...
		switch (_p0.ctor) {
			case 'All':
				return _mdgriffith$style_elements$Element_Attributes$padding(p);
			case 'Left':
				return _mdgriffith$style_elements$Element_Attributes$paddingLeft(p);
			case 'Right':
				return _mdgriffith$style_elements$Element_Attributes$paddingRight(p);
			case 'Bottom':
				return _mdgriffith$style_elements$Element_Attributes$paddingTop(p);
			default:
				return _mdgriffith$style_elements$Element_Attributes$paddingBottom(p);
		}
	});
var _halcwb$genapls$Util_ElementUtils$Top = {ctor: 'Top'};
var _halcwb$genapls$Util_ElementUtils$Bottom = {ctor: 'Bottom'};
var _halcwb$genapls$Util_ElementUtils$Right = {ctor: 'Right'};
var _halcwb$genapls$Util_ElementUtils$Left = {ctor: 'Left'};
var _halcwb$genapls$Util_ElementUtils$All = {ctor: 'All'};

var _halcwb$genapls$Main$responsivePaddingRight = function (model) {
	return A4(
		_halcwb$genapls$Util_ElementUtils$responsivePadding,
		_halcwb$genapls$Util_ElementUtils$Right,
		_elm_lang$core$Basics$toFloat(model.device.size.width),
		10,
		100);
};
var _halcwb$genapls$Main$responsivePaddingLeft = function (model) {
	return A4(
		_halcwb$genapls$Util_ElementUtils$responsivePadding,
		_halcwb$genapls$Util_ElementUtils$Left,
		_elm_lang$core$Basics$toFloat(model.device.size.width),
		10,
		100);
};
var _halcwb$genapls$Main$responsivePadding = function (model) {
	return A4(
		_halcwb$genapls$Util_ElementUtils$responsivePadding,
		_halcwb$genapls$Util_ElementUtils$All,
		_elm_lang$core$Basics$toFloat(model.device.size.width),
		10,
		100);
};
var _halcwb$genapls$Main$notSupported = _mdgriffith$style_elements$Element$text('Oops kan met deze browser de inhoud niet weergeven');
var _halcwb$genapls$Main$footer = function (model) {
	return A3(
		...
		A3(
			...
			},
			{
				...
				_0: A2(
					...
					'http://github.com/halcwb/GenAPLS.git',
					_mdgriffith$style_elements$Element$text('GenAPLS Informedica 2008')),
				_1: {
					ctor: '::',
					_0: A2(
						_mdgriffith$style_elements$Element$link,
					...
					_1: {
						...
						_0: A2(
							...
							_mdgriffith$style_elements$Element$text('Kinderformularium')),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(model.device.size.width),
										A2(
											_elm_lang$core$Basics_ops['++'],
											' x ',
											_elm_lang$core$Basics$toString(model.device.size.height))))),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _halcwb$genapls$Main$navBar = function (model) {
	var title = 'Pediatrische Noodlijst Berekeningen';
	return A3(
		_mdgriffith$style_elements$Element$header,
		_halcwb$genapls$GenStyle$Header,
		{
			ctor: '::',
			_0: _halcwb$genapls$Main$responsivePadding(model),
			_1: {ctor: '[]'}
		},
		_mdgriffith$style_elements$Element$text(title));
};
var _halcwb$genapls$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UrlChange':
				var elist = _halcwb$genapls$Page_EmergencyList$init(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'EListMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							emergencyList: _elm_lang$core$Tuple$first(
								A2(_halcwb$genapls$Page_EmergencyList$update, _p0._0, model.emergencyList))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							device: _elm_lang$core$Native_Utils.update(
								device,
								{size: _p0._0})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _halcwb$genapls$Main$init = F2(
	function (device, location) {
		var elist = _halcwb$genapls$Page_EmergencyList$init(location);
		var model = {emergencyList: elist, device: device};
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _halcwb$genapls$Main$Model = F2(
	function (a, b) {
		return {emergencyList: a, device: b};
	});
var _halcwb$genapls$Main$Device = F3(
	function (a, b, c) {
		return {size: a, userAgent: b, supportsGrid: c};
	});
var _halcwb$genapls$Main$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _halcwb$genapls$Main$subscriptions = function (_p1) {
	return _elm_lang$window$Window$resizes(_halcwb$genapls$Main$Resize);
};
...
var _halcwb$genapls$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _halcwb$genapls$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_halcwb$genapls$Main$UrlChange,
	{init: _halcwb$genapls$Main$init, view: _halcwb$genapls$Main$view, update: _halcwb$genapls$Main$update, subscriptions: _halcwb$genapls$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (size) {
			return A2(
					...
					return A2(
						...
						function (userAgent) {
							return _elm_lang$core$Json_Decode$succeed(
								{size: size, supportsGrid: supportsGrid, userAgent: userAgent});
						},
						A2(_elm_lang$core$Json_Decode$field, 'userAgent', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'supportsGrid', _elm_lang$core$Json_Decode$bool));
		},
		A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _halcwb$genapls$Main$main !== 'undefined') {
    _halcwb$genapls$Main$main(Elm['Main'], 'Main', undefined);
}
